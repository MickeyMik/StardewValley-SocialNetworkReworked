...
internal sealed class ModEntry : Mod
{
    ...
    private void OnDayStarted(object sender, DayStartedEventArgs e) =>
        ...
        this.Villagers = this.GetVillagersAndConnections();
    ...
    private void OnDayEnding(object sender, DayEndingEventArgs e)
    {
        ...
        foreach (VillagerNetwork villager in this.Villagers.Values)
        {
            ...
            if (villager.HeartLevel < CurrentVillagerHearts(villager.Name))
                this.TriggerSocialNetworkBonus(villager, this.Config.SocialNetworkBonus);
    ...
    *********/
    ...
    private void TriggerSocialNetworkBonus(VillagerNetwork villager, int points)
    {
        foreach (string relatedVillager in villager.Relationships)
        {
            ...
            if (points < 0)
                this.ShowNotification($"{relatedVillager}: {points} friendship");
            else if (points > 0)
                this.ShowNotification($"{relatedVillager}: +{points} friendship");
